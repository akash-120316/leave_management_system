...
<body>
    <h1>Accepted Leave Information</h1>
    <div class="container">
    <?php
    include "sql.php";
    session_start();
    ...
    if (isset($_SESSION['logged_in_user'])) {
        ...
        $sql = "SELECT username, leavetype, startdate, enddate, reason, status FROM leaveinfo WHERE status='Accepted' AND email='$loggedInUser'";
